    ...
    const foldersPath = {
        ...
        simpleContracts: {
            source: [
                ...
                '/ethereum/simple/eslintrc.json',
                '/ethereum/simple/package.json',
                '/ethereum/simple/README.md',
                '/ethereum/simple/solcover.js',
                '/ethereum/simple/soliumignore',
                '/ethereum/simple/soliumrc.json',
                '/ethereum/simple/truffle-config.js',
            ],
            destination: [
                '/ethereum/contracts',
                '/ethereum/migrations',
